              ...
              <div className="space-y-3">
                ...
                <div className="rounded-xl border border-blue-200 bg-blue-50 overflow-hidden">
                  ...
                  <div className="px-4 py-3 space-y-2 text-sm leading-6 text-blue-800">
                    <p>报名人数较多，上传高峰可能导致大文件提交失败。单个文件超过 30MB（如视频、PPT 等）时，建议优先使用网盘提交；视频、PPT、图片等材料可整理至同一个网盘链接中。</p>
                    <p><strong>文件命名：</strong>请严格按要求命名所有文件，避免因命名不规范影响审核。</p>
                    <p><strong>多文件打包：</strong>如包含多个设计文件，请先压缩为 ZIP 格式后再上传。</p>
                    <p><strong>网盘信息：</strong>请在对应栏目准确填写网盘链接及提取码，并确认链接可正常访问。</p>
                    <p><strong>提交确认：</strong>提交完成后，请确认页面出现“烟花特效”提示；出现该提示才代表提交成功。</p>
                  </div>
                </div>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-zinc-900 overflow-hidden relative font-sans selection:bg-orange-200 flex flex-col">
      ...
      {/* Header */}
      <header className="relative z-10 flex justify-end items-center p-6 md:p-10">
